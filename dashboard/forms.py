...
class NotificationPreferencesForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'sms_urgent_only': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'discord_enabled': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'discord_webhook_url': forms.URLInput(attrs={'class': 'form-control'}),
        ...
        labels = {
            ...
            'sms_urgent_only': 'Urgent Messages Only',
