/**
 * Bracket Preview Component
 * Handles automatic bracket preview updates and interactions
 */
...
class BracketPreview {
    ...
    init() {
        if (!this.previewContainer) {
            console.log('Bracket preview container not found');
            return;
        }
...
window.BracketPreview = BracketPreview;

// Auto-initialize if container exists
document.addEventListener('DOMContentLoaded', () => {
    if (document.querySelector('.bracket-preview-visual')) {
        new BracketPreview();
    }
});