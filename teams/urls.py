...
urlpatterns = [
    # Marketplace (must be before slug-based routes)
    path('marketplace/', views.TeamMarketplaceListView.as_view(), name='marketplace'),
    path('marketplace/<slug:slug>/purchase/', views.TeamPurchaseView.as_view(), name='marketplace_purchase'),
